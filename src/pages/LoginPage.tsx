...
import { useAuth } from '../hooks/useAuth';  // ← добавить
...
const LoginPage: React.FC<LoginPageProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {  // ← добавить async
        e.preventDefault();
    ...
    return (
        <div className="auth-card">
            ...
            {authError && (
                <div style={{ color: '#ff2430', fontSize: '14px', marginBottom: '12px' }}>
                    {authError}
                </div>
            )}
